...
?>
                ...
                <div id="dash-accordion">
                            ...
                            <li>
                                ...
                                <p>
                                    <?php 
                                        ...
                                        print (strlen($article['content']) > $truncLen ? substr($article['content'],0,$truncLen)."..." : $article['content']);
                                    ?>
                                </p>
                            </li>
                                    <?php
                    ...
                    <div class="accordion-section">
                        <div class="flexbuttons">
                            <button class="dash" type="button" onclick="newPageButton()">New Page</button>
                        </div>
                        <div class="flexbuttons">
                            <button class="dash-gold" type="button" onclick="editPageButton()">Edit Selected</button><button class="dash-red" type="button" onclick="deletePageButton()">Delete Selected</button>
                        </div>
                        <p id="nothing-to-show">No posts could be found.</p>
                        <ul class="page-listing">
                            <?php
                                $articles = $db->getAllPages();
                                $truncLen = 35;
                                foreach ($articles as $article) {
                            ?>
                            <li>
                                <script type="text/javascript">
                                    // generated by PHP
                                    pageMappings.push(<?php print $article['id']; ?>);
                                </script>
                                <h4><?php print $article['title']; ?></h4>
                                <p>
                                    <?php 
        ...
        <script type="text/javascript">
            ...
            var pages = $('.page-listing > li');
            var selectedPage = -1;
            pages.click(function(){
                pages.removeClass('selected');
                $(this).addClass('selected');  
                selectedPage = $(this).index();
                console.log('page picked ' + selectedPage);
            ...
            function newPageButton() {
                window.location.href = "page-editor.php";
            }

            function editPageButton() {
                if (selectedPage == -1) return;
                window.location.href = "page-editor.php?page=" + pageMappings[selectedPage];
            }

            function deletePageButton() {
                if (selectedPage == -1) return;
                if (confirm("Are you sure you want to delete this page?")) {
                    window.location.href = "page-editor.php?selected=" + selectedPage + "&page=" + pageMappings[selectedPage] + "&delete=true";
                }
            }
        </script>
    </body>
